...
pub use encode::{
    ...
    set_lazy_fill_threshold_arm, set_prefix_bound_arm, set_dfast_fill_stride_arm, set_dfast_fill_anchor_arm, set_dfast_fill_n_arm, take_dfast_endfill, take_dfast_fill, set_prime_bt_arm, set_prime_bt_tree_arm, set_prime_bt_depth_arm, set_prime_stride_arm, take_prime_iters,
