...
pub use encode::{
    ...
    set_huff_fast_arm, set_lazy_fill_arm, set_litpush_arm, set_litpush_hoist_arm, set_payload_arm, set_pipe_arm, set_pipe_rep1_arm, take_ff_pipe, take_mm, take_tag_rejects,
