...
pub use encode::{
    ...
    set_lazy_fill_threshold_arm, set_prefix_bound_arm, set_prefix_window_arm, take_next_long, take_nl_band, take_nl_off, set_nl_off_worse_arm, set_nl_dispatch_arm, set_dfast_good_ml_arm, set_dfast_good_ml2_arm, set_dfast_fill_stride_arm, set_dfast_fill_anchor_arm, set_dfast_fill_n_arm, take_dfast_endfill, set_replen_pipe_arm, set_accel_shift_arm, set_opt_hoist_arm, set_opt_ops_arm, set_finder_scratch_arm, set_dfast_tag_arm, set_long_tag_arm, set_walk_cont_arm, set_walk_rep_max_arm, set_lazy_gain_arm, set_walk_first_max_arm, set_chain_tag_arm, set_rep_reprobe_arm, set_wide_chain_arm, set_wide_first_max_arm, set_wide_spb_min_arm, set_opt_fill_stride_arm, set_opt_fill_max_arm, take_opt_fill_ins, take_dfast_fill, set_prime_bt_arm, set_prime_bt_tree_arm, set_prime_bt_depth_arm, set_prime_bt_extent_arm, set_prime_stride_arm, take_prime_iters,
