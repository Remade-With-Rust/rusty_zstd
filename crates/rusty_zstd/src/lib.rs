...
#[cfg(feature = "alloc")]
pub use encode::{
    reset_env_arms, set_opt_lit_arm, set_pair_gain_arm, set_pair_hi_arm, set_pair_pre_arm, set_tag_arm, set_tag_alloc_arm, set_bt_spec_arm, set_next_long_arm, set_pair_on_arm, take_pair_stats, take_pair_split, set_dfast_spec_arm, set_dfast_pipe_arm, set_dfast_step_arm, set_dfast_spec_min_arm, set_fast_spec_arm, take_bt_calls, take_bt_probe_stats, take_dfast_calls, take_dfast_spec, take_dfast_match_stats, take_finder_calls,
    set_huff_fast_arm, set_lazy_fill_arm, set_litpush_arm, set_litpush_hoist_arm, set_payload_arm, set_pipe_arm, set_pipe_rep1_arm, take_ff_pipe, take_mm, take_rep_rate, take_tag_rejects,
