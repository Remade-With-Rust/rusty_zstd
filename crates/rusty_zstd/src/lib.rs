...
#[cfg(feature = "alloc")]
pub use encode::{
    reset_env_arms, set_opt_lit_arm, set_pair_gain_arm, set_pair_hi_arm, set_tag_arm, set_tag_alloc_arm, set_bt_spec_arm, set_next_long_arm, set_pair_on_arm, take_pair_stats, take_pair_split, set_dfast_spec_arm, set_dfast_pipe_arm, set_dfast_step_arm, set_dfast_spec_min_arm, set_fast_spec_arm, take_bt_calls, take_bt_probe_stats, take_dfast_calls, take_dfast_spec, take_dfast_match_stats, take_dfast_rep_blocks, take_opt_rep, take_opt_bt, set_opt_rep_arm, take_finder_calls,
