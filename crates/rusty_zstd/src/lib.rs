...
pub use encode::{
    ...
    set_step0_arm, set_step_probe_arm, set_step_forfeit_arm, set_step_seq_arm, set_g5_arms, set_g5_fast_arms, set_g5_opt_arms, set_lit_short_arm, take_lp_guard, set_lit_push_width_arm, take_lp_stats,
};
#[cfg(all(feature = "alloc", feature = "std"))]
pub use in_bench::{
