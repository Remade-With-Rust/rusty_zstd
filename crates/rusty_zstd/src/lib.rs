...
#[cfg(feature = "alloc")]
pub use encode::{
    reset_env_arms, set_tag_arm, set_bt_spec_arm, set_next_long_arm, set_pair_on_arm, take_pair_stats, set_dfast_spec_arm, set_fast_spec_arm, take_bt_calls, take_dfast_calls, take_finder_calls,
